...
{
    public sealed class DefaultDrawSpriteRegister : IApp
    {
        ...
        /// コンストラクタ
        /// </summary>
        public DefaultDrawSpriteRegister(Application app)
        {
            App = app;
            m_defDrawCommandId = (int)DCRL.DEF_SPRITE;
            m_defTechnicId = (int)EffectID.Default;
        }
        /// <summary>
        /// デストラクタ
        /// </summary>
        ~DefaultDrawSpriteRegister() { }
